"""numerical atomic orbital is different from pseudopotential.
For pseudopotentials are always ready to download presently (if not consider
generation of pseudopotential). While the numerical atomic orbitals are not
always ready to download, for they are generated by the ourselves."""
