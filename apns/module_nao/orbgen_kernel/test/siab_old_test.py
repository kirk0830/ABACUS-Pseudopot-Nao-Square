import unittest
import apns.module_nao.orbgen_kernel.siab_old as siab_old
...
class SiabTest(unittest.TestCase):
    ...
    def test_merge_dicts(self):
        ...
        result = siab_old.merge_dicts(source)
        ...
        result = siab_old.merge_dicts(source, value_tostr=True)
        self.assertEqual(result, {
            "key1": ["1", "1"],
            "key2": ["2", "2"]
        })
        ...
        result = siab_old.merge_dicts(source, value_tostr=True, delimiter=",")
        self.assertEqual(result, {
            "key1": ["1,2", "1,2"],
            "key2": ["3,4", "3,4"]
        })
    ...
    def test_dict_tostr(self):
        ...
        result = siab_old.dict_tostr(source=source,
    ...
    def test_dicts_tostr(self):
        ...
        result = siab_old.dicts_tostr(source=source,
                                  key_sequence=["key1", "key2"],
                                  direction="vertical",
                                  comment_sign="#",
                                  with_key=True,
    ...
    def test_siab_program_section(self):
        result = siab_old.siab_program_section(mpi_command="mpirun -np 4",
...
"""
    ...
    def test_siab_electronic_calculation(self):
        ...
        result = siab_old.siab_electronic_calculation(element="H",
                                                  ecutwfc=100,
                                                  rcut=5,
...
"""
    ...
    def test_siab_reference_system(self):
        ...
        result = siab_old.siab_reference_system(reference_systems=reference_systems,
                                            nspin=1,
                                            lmax=2,
...
""" 
    ...
    def test_siab_siabparams(self):
        ...
        result = siab_old.siab_siabparams(minimal_basis=[2, 1, 1],
...
"""
    ...
    def test_siab_save(self):
        ...
        result = siab_old.siab_save(orbital_configurations=orbital_configurations)
...
"""
    ...
    def test_orbitalconfig_tolist(self):
        """single orbital"""
        self.assertEqual(siab_old.orbitalconfig_tolist("1s"), [1])
        self.assertEqual(siab_old.orbitalconfig_tolist("2p"), [0, 2])
        self.assertEqual(siab_old.orbitalconfig_tolist("3d"), [0, 0, 3])
        """multiple orbitals"""
        self.assertEqual(siab_old.orbitalconfig_tolist("1s2p"), [1, 2])
        self.assertEqual(siab_old.orbitalconfig_tolist("1s3d"), [1, 0, 3])
        self.assertEqual(siab_old.orbitalconfig_tolist("2p3d"), [0, 2, 3])
        self.assertEqual(siab_old.orbitalconfig_tolist("1s2p3d"), [1, 2, 3])
        """multiple orbitals with different number of orbitals"""
        self.assertEqual(siab_old.orbitalconfig_tolist("1s2p3d4f"), [1, 2, 3, 4])

    def test_zeta_notation_toorbitalconfig(self):
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZ", [2, 1, 1]), "2s1p1d")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZP", [2, 1, 1]), "2s1p1d1f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZ9P", [2, 1, 1]), "2s1p1d9f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("DZ", [2, 1, 1]), "4s2p2d")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("DZP", [2, 1, 1]), "4s2p2d1f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("TZDP", [2, 1, 1]), "6s3p3d2f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("QZDP", [2, 1, 1]), "8s4p4d2f")

        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZ", [2, 0, 1, 1]), "2s1d1f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZP", [2, 0, 1, 1]), "2s1d1f1g")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("SZ9P", [2, 0, 1, 1]), "2s1d1f9g")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("DZ", [2, 0, 1, 1]), "4s2d2f")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("DZP", [2, 0, 1, 1]), "4s2d2f1g")
        self.assertEqual(siab_old.zeta_notation_toorbitalconfig("TZDP", [2, 0, 1, 1]), "6s3d3f2g")                         
    ...
    def test_SIAB_INPUT(self):
        ...
        result = siab_old.SIAB_INPUT(element="Fe",
                                 ecutwfc=100,
                                 nspin=1,
                                 rcut=[6, 7, 8, 9, 10],
...
"""
    ...
    def test_siab_input_parse(self):
        result = siab_old.siab_input_parse("./apns/module_nao/generation/test/support/SIAB_INPUT")
    
    def test_set_bond_length_fromfile(self):
        result = siab_old.set_bond_length_fromfile("./apns/module_nao/generation/test/support/SIAB_INPUT", [
